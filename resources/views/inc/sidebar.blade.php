            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                ...
                @if ($page_name != 'alt_menu' && $page_name != 'blank_page' && $page_name != 'boxed' && $page_name != 'breadcrumb')
                    ...
                    <li class="menu {{ $category_name === 'apps' ? 'active' : '' }}">
                        <a href="#app" data-active="{{ $category_name === 'apps' ? 'true' : 'false' }}"
                        ...
                        <ul class="collapse submenu list-unstyled {{ $category_name === 'apps' ? 'show' : '' }}"
                    ...
                    <li class="menu {{ $category_name === 'components' ? 'active' : '' }}">
                        <a href="#components" data-active="{{ $category_name === 'components' ? 'true' : 'false' }}"
                            data-toggle="collapse"
                            aria-expanded="{{ $category_name === 'components' ? 'true' : 'false' }}"
                            class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <ul class="collapse submenu list-unstyled  {{ $category_name === 'components' ? 'show' : '' }}"
                    ...
                    <li class="menu {{ $category_name === 'elements' ? 'active' : '' }}">
                        <a href="#elements" data-active="{{ $category_name === 'elements' ? 'true' : 'false' }}"
                            data-toggle="collapse"
                            aria-expanded="{{ $category_name === 'elements' ? 'true' : 'false' }}"
                            class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <ul class="collapse submenu list-unstyled {{ $category_name === 'elements' ? 'show' : '' }}"
                    ...
                    <li class="menu {{ $category_name === 'fonticons' ? 'active' : '' }}">
                        <a href="/font_icons" data-active="{{ $category_name === 'fonticons' ? 'true' : 'false' }}"
                            aria-expanded="{{ $category_name === 'fonticons' ? 'true' : 'false' }}"
                            class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <li class="menu {{ $category_name === 'widgets' ? 'active' : '' }}">
                        <a href="/widgets" data-active="{{ $category_name === 'widgets' ? 'true' : 'false' }}"
                            aria-expanded="{{ $category_name === 'widgets' ? 'true' : 'false' }}"
                            class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <li class="menu {{ $category_name === 'bootstrap_basic_table' ? 'active' : '' }}">
                        <a href="/tables/bootstrap_basic"
                            data-active="{{ $category_name === 'bootstrap_basic_table' ? 'true' : 'false' }}"
                            aria-expanded="{{ $category_name === 'bootstrap_basic_table' ? 'true' : 'false' }}"
                            class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <li class="menu {{ $category_name === 'datatable' ? 'active' : '' }}">
                        <a href="#datatables" data-active="{{ $category_name === 'datatable' ? 'true' : 'false' }}"
                            data-toggle="collapse"
                            aria-expanded="{{ $category_name === 'datatable' ? 'true' : 'false' }}"
                            class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <ul class="collapse submenu list-unstyled {{ $category_name === 'datatable' ? 'show' : '' }}"
                    ...
                    <li class="menu {{ $category_name === 'forms' ? 'active' : '' }}">
                        <a href="#forms" data-active="{{ $category_name === 'forms' ? 'true' : 'false' }}"
                            data-toggle="collapse" aria-expanded="{{ $category_name === 'forms' ? 'true' : 'false' }}"
                            class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <ul class="collapse submenu list-unstyled {{ $category_name === 'forms' ? 'show' : '' }}"
                    ...
                    <li class="menu {{ $category_name === 'pages' ? 'active' : '' }}">
                        <a href="#pages" data-active="{{ $category_name === 'pages' ? 'true' : 'false' }}"
                            data-toggle="collapse" aria-expanded="{{ $category_name === 'pages' ? 'true' : 'false' }}"
                            class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <ul class="collapse submenu list-unstyled {{ $category_name === 'pages' ? 'show' : '' }}"
                    ...
                    <li class="menu {{ $category_name === 'auth' ? 'active' : '' }}">
                        <a href="#authentication" data-active="{{ $category_name === 'auth' ? 'true' : 'false' }}"
                            data-toggle="collapse" aria-expanded="{{ $category_name === 'auth' ? 'true' : 'false' }}"
                            class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <ul class="collapse submenu list-unstyled {{ $category_name === 'auth' ? 'show' : '' }}"
                    ...
                    <li class="menu {{ $category_name === 'drag_n_drop' ? 'active' : '' }}">
                        <a href="/drag_and_drop" data-active="{{ $category_name === 'drag_n_drop' ? 'true' : 'false' }}"
                            aria-expanded="{{ $category_name === 'drag_n_drop' ? 'true' : 'false' }}"
                            class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <li class="menu {{ $category_name === 'maps' ? 'active' : '' }}">
                        <a href="/maps" data-active="{{ $category_name === 'maps' ? 'true' : 'false' }}"
                            aria-expanded="{{ $category_name === 'maps' ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <li class="menu {{ $category_name === 'charts' ? 'active' : '' }}">
                        <a href="/charts" data-active="{{ $category_name === 'charts' ? 'true' : 'false' }}"
                            aria-expanded="{{ $category_name === 'charts' ? 'true' : 'false' }}"
                            class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <li class="menu">
                        <a href="https://designreset.com/cork/documentation/" aria-expanded="false"
                            class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
